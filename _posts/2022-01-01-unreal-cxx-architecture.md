...
- [Delegates](#delegates)
- [World context object](#world-context-object)
- [Class Default Object](#class-default-object)
- [Touch events](#touch-events)
- [BeginDeferredActorSpawnFromClass and FinishSpawningActor](#begindeferredactorspawnfromclass-and-finishspawningactor)
- [AActor VS UObject](#aactor-vs-uobject)
	- [AActor](#aactor)
	- [UObject](#uobject)
- [Strings](#strings)
	- [FString](#fstring)
...
**Links:**
- [Event Dispatcher vs Blueprint Event](https://stackoverflow.com/questions/62165120/c-equivalent-blueprint-event-dispatcher-vs-blueprint-events)
- [Delegate source code analysis](https://www.programmersought.com/article/8873853019/)
- [FCoreDelegate](https://docs.unrealengine.com/en-US/API/Runtime/Core/Misc/FCoreDelegates/index.html)
- [CoreDelegates](https://ikrima.dev/ue4guide/gameplay-programming/master-engine-flow/core-eventsdelegates/)
...
**Links: [Creating C++ Functions as new Blueprint Nodes](https://michaeljcole.github.io/wiki.unrealengine.com/Blueprints,_Creating_C++_Functions_as_new_Blueprint_Nodes/)**
...
- [GetDefaultObject](https://docs.unrealengine.com/latest/INT/API/Runtime/CoreUObject/UObject/UClass/GetDefaultObject/1/index.html)
...
**Links: [Class constructor](https://docs.unrealengine.com/latest/INT/Programming/UnrealArchitecture/Reference/Classes/#classconstructor)**
...
**Links: [Spawning an actor with parameters](https://answers.unrealengine.com/questions/284744/spawning-an-actor-with-parameters.html)**
...
**Links: [Difference between UObject and AActor](https://answers.unrealengine.com/questions/296674/noob-question-difference-between-object-actor.html)**
